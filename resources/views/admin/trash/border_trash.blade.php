...
@section('content')
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    <span class="fa fa-trash-o"></span> Trash List
{{--                    <span>{{$count}}</span>--}}
                </h2>
                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        @foreach($borders as $key=>$border)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-lg-3 col-lg-pull-12"> <a href="{{url('border_restore',$border->id)}}"><button  class="btn btn-info fa fa-recycle" title="Restore";"></button></a></div>
